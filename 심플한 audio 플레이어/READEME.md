...
- html
    ...
    <div id="audio" class="player-wrapper">
        <audio-player file="mp3 file url"></audio-player>
    </div>
    ```
        ...
        template: `
            <div class="player">
                <div class="player-controls">
                    ...
                    <div id="volume">
                        <a v-on:click.prevent="" v-on:mouseenter="showVolume = true" v-on:mouseleave="showVolume = false" :title="'Volume (' + volume + '%)'" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
# 참고
- https://codepen.io/numerical/pen/yKMaaP
